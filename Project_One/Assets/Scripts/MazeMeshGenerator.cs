...
public class MazeMeshGenerator
{
    ...
    public Mesh FromData(int[,] data)
    {
        ...
        //each list of triangles is a different sub-mesh. 
        //You declare two sub-meshes so that you can assign different materials to the floor and walls.
        ...
        //While every cell needs a floor and ceiling, there are checks of adjacent cells to see which walls are needed
    ...
    //the first line of the method gets the index to start from; as more quads are appended, the index will increase.
    // first AddQuad() parameter is a transformation matrix,
